...
export const SCENARIOS: Scenario[] = [
    {
        ...
        prompt: "Get dentists in Austin with their emails",
        working: "Searching Maps for dentists in Austin…",
        found: "Found 48 businesses · finding emails…",
        total: "48",
        columns: ["Name", "Phone", "Email"],
        rows: [
            ["Bright Smile Dental", "(512) 555-0142", "hello@brightsmile.com"],
            ["Lakeside Family Dentistry", "(512) 555-0187", "office@lakesidefd.com"],
            ["Congress Ave Dental Care", "(512) 555-0123", "info@congressdental.com"],
            ["Hill Country Orthodontics", "(512) 555-0164", "smile@hcortho.com"],
        ],
